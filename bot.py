...
async def help_user_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "🔸 Ознакомиться с хорошими товарами - нажмите 'Покупать', затем выберите интересующую категорию. Отобразиться список продуктов, под некоторым из них будет значок фотоаппарата - при нажатии на него бот пришлет фото продукта с описанием\n"
        "🔸 Ознакомиться с плохими товарами - нажмите 'Не покупать', затем выберите интересующую категорию. Отобразиться список продуктов, под некоторым из них будет значок фотоаппарата - при нажатии на него бот пришлет фото продукта с описанием\n\n"
